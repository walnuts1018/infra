  ...
  section_map = {
    terraform = {
      field_map = {
        ...
        "openunison-client-id"         = { type = "STRING", value = var.openunison_client_id }
        "openunison-client-secret"     = { type = "CONCEALED", value = var.openunison_client_secret }
        "openunison-keystore-password" = { type = "CONCEALED", value = var.openunison_keystore_password }
