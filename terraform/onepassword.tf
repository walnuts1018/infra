module "onepassword" {
  ...
  openunison_client_id         = module.zitadel.openunison_oidc_client_id
  openunison_client_secret     = module.zitadel.openunison_oidc_client_secret
  openunison_keystore_password = random_password.openunison_keystore.result
...
resource "random_password" "openunison_keystore" {
  length  = 48
  special = false
}
