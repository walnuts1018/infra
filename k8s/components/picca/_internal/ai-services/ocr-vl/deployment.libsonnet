        ...
        spec: {
          ...
          initContainers: [
            {
              ...
              image: 'ghcr.io/walnuts1018/picca/ai-paddle:v0.0.91@sha256:c1ac9dc900d239b3711aa386681a537586bbc5f0b473321898af4753274ef836',
          ...
          volumes: [
            ...
            { name: 'paddlex-models', emptyDir: { sizeLimit: '8Gi' } },
            {
              name: 'model-source',
              image: {
                reference: 'ghcr.io/walnuts1018/picca/ai-models-ocr-vl:v0.0.62',
